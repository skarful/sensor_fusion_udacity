...
#include "3dtree.h" //For custom clustering
...
public:
    ...
    void proximityFunctionCustom(const int id, const std::vector<std::vector<float>>& points, KdTree* tree, std::vector<int>& cluster, std::vector<bool>& processed,const float distanceTol);
